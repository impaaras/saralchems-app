  ...
  return (
    <View style={shimmerStyles.card}>
      ...
      <View style={shimmerStyles.imageContainer}>
        ...
        {/* Add Button Shimmer */}
        <Animated.View style={[shimmerStyles.shimmerAddButton, {opacity}]} />
      </View>
      ...
      <View style={shimmerStyles.infoContainer}>
        ...
        <View style={shimmerStyles.variantsContainer}>
          ...
          />
          <Animated.View style={[shimmerStyles.shimmerMoreButton, {opacity}]} />
        </View>

        {/* Product Name */}
        <Animated.View style={[shimmerStyles.shimmerName, {opacity}]} />
        <Animated.View style={[shimmerStyles.shimmerNameSecond, {opacity}]} />

        {/* Brand Info */}
        <View style={shimmerStyles.brandInfo}>
          <Animated.View style={[shimmerStyles.shimmerBrand, {opacity}]} />
          <Animated.View style={[shimmerStyles.shimmerUnit, {opacity}]} />
        </View>
      </View>
    </View>
  );
