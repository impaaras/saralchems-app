...
const getCardWidth = () => {
  if (screenWidth < 350) return '48%'; // 2 columns for small phones
  if (screenWidth < 500) return '32%'; // 3 columns for medium phones
...
const styles = StyleSheet.create({
  card: {
    ...
    marginBottom: hp(0.6),
    flexDirection: 'column',
    marginHorizontal: wp(0.5), // Add small horizontal margin for better spacing
  },
